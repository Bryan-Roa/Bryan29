  ...
  /* Estructuras-1. El programa muestra la manera en que se declara una estructura, así como la
  forma en que se tiene acceso a los campos de las variables de tipo estructuratanto para asignación de
  valores como para lectura y escritura. */
