  ...
  /* Estructuras-2.
El programa muestra la manera en que se declara una estructura, así como la forma en que se tiene acceso a los campos
de los apuntadores de tipo estructura tanto para lectura como para escritura. Se utiliza además una función que
  ...
  struct alumno
{
    ...
    char direccion[20];
          ...
          void main(void)
          {
              ...
              a3 = &a0; /* En este caso al apuntador de tipo estructura alumno a3se le asigna la dirección de
