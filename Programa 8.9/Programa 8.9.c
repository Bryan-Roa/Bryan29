  ...
  /* Bienes raíces.
El programa maneja información sobre las propiedades que tiene una empresa de bienes
raíces de la ciudad de Lima, Perú, tanto para venta como para renta. */
...
/* Esta función se utiliza para generar un listado de las propiedades disponibles para venta en la
zona de Miraflores, cuyo valor oscila entre450,000 y 650,000 nuevos soles. */
...
/*  Al recibir como datos una zona geográfica de Lima, Perú, y un cierto rangorespecto al monto, esta función genera
...
scanf("%f", &ls);
for (I=0; I<T; I++)
if ((A[I].dispo == ‘R’) && (strcmp (A[I].ubi.zona, zon)
