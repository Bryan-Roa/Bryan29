...
/* Intercambia. El programa intercambia las columnas de arreglo bidimensional. los elementos de la primera columna
se intercambian con los de la ultima, los de la segunda con los de la penultima, y asi sucesivamente.*/
...
void main(void)
{
    ...
    while (C > MAX || C < 1); /* Se verifica que el numero de columnas sea correcta*/
