 ...
 /* Escuela. El programa genera información importante de los alumnos de una escuela. */
...

 {
    ...
    matpro cal[5];           /* Observa que cal es un arreglo unidimensional de tipo estructura matpro —la
    estructura definida en primer término. */
...
/* Esta función se utiliza para obtener la matrícula y el promedio general de cada alumno. */

  {
   ...
   printf("\tPromedio: %.2f", SUM);
    ...
    void F2(alumno A[], int T) /* Esta función se utiliza para obtener las matrículas de los alumnos cuya
    calificación en la tercera materia es mayor a 9. */

    int I;
     printf(\"nAlumnos con calificación mayor a 9 en la tercera materia");
     for (I=0; I<T; I++)
     if (A[I].cal[2].pro > 9)
    printf("\nMatrícula del alumno : %d", A[I].matri);
