...
/* Lluvias. El programa, al recibir como dato un arreglo tridimensional que contiene informacion
sobre lluvias, genera informacion estadistica.*/
...
void Funcion2(float A[][MES][ANO], int F, int C, int P)
{
    ...
    printf("Provincia con menor registro anual de lluvias en el ultimo ano: %d", EMEN+1);
