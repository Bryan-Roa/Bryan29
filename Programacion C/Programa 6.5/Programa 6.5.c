...
/* Alumnos. El programa, al recibir un arreglo bidimensional que contiene informacion sobre calificaciones de
alumnos en cuatro material diferentes, obtiene resultados estadisticos.*/
...
void main(void)
{
    ...
    do
    {
        ...
        scanf("%d", &NAL); /* Se verifica que el numero de alumnos del grupo sea valido.*/
