...
/* Cuadrado magico. El programa genera un cuadrado magico siguiente los criterios enunciados
anteriormente. */
...
void main(void)
{
    ...
    while ((TAM > MAX || TAM < 1 ) && (TAM % 2)); /* Se verifica el tamano del arreglo y el orden impar del mismo*/
    Cuadrado(CMA, TAM);
    Imprime(CMA, TAM);
