...
IX = IX + 4;
Y = *IX; /* IX se modifica. Observa que el apuntador se mueve 4 posiciones y cae en una dirección afuera del arreglo. Esto ocasionará unerror. */ /* Y se modifica, toma el valor (basura) de una celda incorrecta. Es un error que no señala el compilador del lenguaje C. */
