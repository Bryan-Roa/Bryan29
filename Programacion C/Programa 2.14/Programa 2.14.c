...
/* Telefono. El programa, al recibir como datos la clave de la zona
geografica y el numero de segundos de una llamada telefonica,
calcula el costo de la misma.
