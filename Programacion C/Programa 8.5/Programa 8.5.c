   ...
   /* Uniones. El programa muestra la manera como se declara una unión, así como la forma de
     acceso a los campos de las variables de tipo unión tanto para asignación de valores como para lectura y escritura. */
   ...
   /* Observa que sólo el primer componente de una unión puede recibir valores por medio de este tipo de asignaciones. */
   ...
   /* Impresión de resultados. */
    ...
    puts(a1.carrera);
    printf("%.2f\n", a1.promedio);
    puts(a1.personales.celular);      /* Observa que escribe el valor*/

    puts(a1.personales.correo);

    strcpy(a0.personales.correo, “hgimenez@hotmail.com”); /* Se ingresa ahora un valor al segundo campo de la unión de la variable a0. */

   puts(a0.personales.celular); /* Ahora escribe basura en el campo del teléfono celular. */

   puts(a0.personales.correo); /* Escribe el contenido del campo (hgimenez@hotmail.com). */
