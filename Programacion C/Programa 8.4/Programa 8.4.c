    ...
    /* Escuela. El programa genera información estadística de los alumnos de una escuela. */
...

    {
     ...
     while (TAM > 50 || TAM < 1);            /* Se verifica que el tamaño del arreglo sea correcto. */
        ...
        void Lectura(alumno A[], int T) /* La función Lectura se utiliza para leer un arreglo unidimensional de tipo estructura alumno de T elementos. */
        ...
        void F1(alumno A[], int T)    /* La función F1 obtiene la matrícula y el promedio de cada alumno. */
        ...
        void F2(alumno A[], int T) /* La función F2 obtiene las matrículas de los alumnos cuya calificación en la
