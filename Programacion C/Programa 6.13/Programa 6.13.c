...
/* Empresa textil.El programa, al recibir un arreglo tridimensional que contiene información sobre las ventas mensuales
de tres departamentos en los últimos ocho años, genera información estadística valiosa para la empresa. */
...
void Lectura(float A[][DEP][ANO], int F, int C, int P) /* La función Lectura se utiliza para leer un arreglo tridimensional de tipo
