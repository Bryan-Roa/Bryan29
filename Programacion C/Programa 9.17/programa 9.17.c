...
/* Reemplaza palabras.
El programa lee cadenas de caracteres de un archivo y cada que vez que encuentra la palabra México escrita en forma incorrecta
la primera con minúscula— la reemplaza por su forma correcta y escribe la cadena en otro archivo. */
...
/* Esta función reemplaza en la cadena de caracteres la palabra méxico escrita con minúsculas —la primera letra— por su
forma correcta y escribe la cadena de caracteres en un nuevo archivo. */
...
k = i - j;    /* En k se almacena la diferencia de las longitudes de las cadenas cad1 y cad2. */
   ...
   if (k)
{
strncpy(aux, cad1, k); /* Se copia la subcadena de k caracteres de cad1 a aux —desde el inicio de cad1 hasta el caracter anterior a méxico. */
aux[k] = '\0';
