 ...
 /* Vendedores. El programa maneja información sobre las ventas que realizan los vendedores de artículos
 domésticos de una importante empresa de la Ciudad de México. */
  ...
  typedef struct                     /* Declaración de la estructura vendedor. */
{
 ...
 do
 {
  ...
  printf("\n\tFIN DEL PROGRAMA");
   ...
   void Lectura(vendedor A[], int T) /* Esta función se utiliza para leer un arreglo unidimensional de tipo estructura
   vendedor de T elementos. */
   ...
   void F1(vendedor A[], int T) /* Esta función se utiliza para generar las ventas totales anuales de cada uno
   ...
   void F2(vendedor A[], int T) /* Esta función se utiliza para incrementar 5% el salario de todos aquellos
  ...
  for (I=0; I<T; I++)
  {
    ...
    void F3(vendedor A[], int T)  /* Esta función se utiliza para generar un listado de todos aquellos vendedores
    que en el año vendieron menos de $300,000. */

    {
     ...
     void F4(vendedor A[], int T) /* Esta función se usa para imprimir el número de empleado, el nombre del banco y
     el número de cuenta de todos aquellos empleados a quienes se les
