...
/* Casa de bolsa. El programa, al recibir como datos los precios mensuales de las acciones de sus
cincos fondos de inversion, ademas del precio de las acciones al 31 de diciembre del 2003, genera
informacion estadistica importante para la empresa*/
...
void main(void)
{
    float FON[5][12], PRE[5], REN[5]; /* REN es un arreglo unidimensional de  tipo real que se utilizara para
    almacenar el rendimiento anual de los fondos de inversion.*/
...
void F2(float A[][12], int F, int C)
{
    int I, J;
    float SUM, PRO;
    printf("\n\nPROMEDIO ANALIZADO DE LAS ACCIONES DE LOS FONDOS");
    for (I=0; I<R; I++)
    {
        SUM = 0;
        for (J=0; J<C; J++)
