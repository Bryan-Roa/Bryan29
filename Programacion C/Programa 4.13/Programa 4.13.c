...
/* Pares e impares. El programa, al recibir como datos N numeros enteros, calcula cuantos
...
/* La funcion incrementa el parametro el *p o I, segun sea el numero par o impar.*/
