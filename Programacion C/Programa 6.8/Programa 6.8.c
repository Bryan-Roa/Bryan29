...
void main(void)
{
    ...
    do
    {
        printf("Ingrese el numero de columnas de matriz:");
        scanf("%d", &COL);
    }
    while (COL > MAX || COL < 1);
...
void Lectura(int A[][MAX], int F, int C) /* Esta funcion se utiliza para una matriz de tipo entero de f filas Y c columnas*/
{
    int I, J;
    for (I=0; I<F; I++)
        for (J=0; J<C; J++)
