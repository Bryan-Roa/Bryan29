  ...
  /* Estructuras-3. El programa muestra la manera en que se declara una estructura anidada, así
     como la forma de acceso a los campos de las variables o apuntadores de tipo estructura, tanto
     para lectura como para escritura. Se utiliza además una función que recibe como parámetro un apuntador de tipo estructura. */
        ...
        {
            char nombre[20];
            char departamento[20];        /* direccion es un campo de tipo estructura domicilio de la estructura empleado. */
            float sueldo;
            domicilio direccion;
    ...
    printf("Ingrese el departamento de la empresa: ");
     ...
     fflush(stdin);
      gets(e1->direccion.localidad);
        ...
        /* En la función Lectura se leen los campos de una variable, e4, y un apuntador de tipo estructura, *e2. */
