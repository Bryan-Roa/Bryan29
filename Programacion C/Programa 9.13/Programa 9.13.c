...
/* Cuenta caracteres. El programa, al recibir como dato un archivo de texto y un caracter, cuenta
...
int cuenta(char car) /* Esta función determina cuántas veces se encuentra el caracter en el archivo. */
{
int res, con = 0;
char p;
FILE *ar;
