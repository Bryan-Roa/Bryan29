...
/* Examen de admisión. El programa, al recibir como dato un archivo de acceso directo que contiene información
sobre los alumnos que presentaron el examen de admisión a una universidad, genera información importante para
...
float F1(FILE *ap)  /* Esta función obtiene el promedio del examen de admisión. */
{
alumno alu;
float sum = 0, pro;
int i = 0;
...
/* Esta función genera un archivo de los alumnos admitidos en cada una de las carreras de la universidad. */
